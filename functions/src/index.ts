...
app.get('/proposals/:id', crm.getProposal);
app.post('/proposals/:id/accept', crm.acceptProposal);
app.post('/proposals/:id/pay', crm.payProposal);
...
// --- Marketing Routes ---
app.get('/research-prospect', marketing.researchProspect);
app.post('/generate-marketing-content', marketing.generateContent);
app.post('/generate-lead-list', marketing.generateLeadList);
