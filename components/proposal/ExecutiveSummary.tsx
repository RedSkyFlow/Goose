...
import { ShieldCheckIcon, SparklesIcon, TrendingUpIcon } from '../icons';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                ...
                <div className="space-y-8">
                    <div>
                        ...
                        <div className="prose prose-invert prose-lg text-gray-300 print:text-black">
                            <p>{summary}</p>
                        </div>
                    </div>
                ...
                <div className="space-y-8">
                    <h3 className="text-white text-2xl font-bold mb-6 border-b border-white/10 pb-4 print:text-black print:border-black">Projected Impact</h3>
                        ...
                        {roiProjections.map((roi, index) => (
                            <div key={index} className="flex items-start p-4 rounded-lg hover:bg-white/5 transition-colors print:border print:border-gray-300">
                                <div className="flex-shrink-0 mr-4 mt-1">
                                    {index === 0 ? <TrendingUpIcon className="w-8 h-8 text-accent print:text-black" /> :
                                     index === 1 ? <ShieldCheckIcon className="w-8 h-8 text-primary print:text-black" /> :
                                     <SparklesIcon className="w-8 h-8 text-secondary print:text-black" />}
                                </div>
                                <div>
